...
use crate::model::api::NewThreadRequest;
...
impl Validatable for NewThreadRequest {
    fn validate(&self) -> Result<()> {
        ...
        if self.message_user_data.is_empty() {
            bail!("missing message data")
        }
...
impl crate::model::extensions::Signer for NewThreadRequest {
...
impl Signed for NewThreadRequest {
